...
export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{ borderTop: "1px solid rgba(194,65,12,0.3)" }}
    >
      {/* Top glow line */}
      <div
      ...
      <div
        className="relative"
        style={{ background: "linear-gradient(to bottom, #070d1a, #030609)" }}
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-12 pb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
            ...
            <div className="space-y-4">
              <CyberLogo />
              <h3
                className="text-orange-400 font-black text-lg tracking-widest uppercase mt-2"
                style={{ textShadow: "0 0 8px rgba(249,115,22,0.6)" }}
              >
                RIT-B Techfest 2026
              </h3>
              <p className="text-slate-500 text-xs leading-relaxed tracking-wide max-w-xs">
                The premier technology festival of RIT Bangalore — a convergence
                of innovation, creativity, and cutting-edge engineering. Join us
                for a journey into the future of technology.
              </p>
              <div className="flex items-center gap-2 mt-4">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to right, rgba(194,65,12,0.6), transparent)",
                  }}
                />
                <span className="text-orange-700 text-[10px] tracking-widest">
                  2026
                </span>
                <div
                  className="h-px flex-1"
                  style={{
                    background:
                      "linear-gradient(to left, rgba(194,65,12,0.6), transparent)",
                  }}
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h4
                className="text-orange-500 font-bold text-xs tracking-[0.3em] uppercase flex items-center gap-2"
                style={{ textShadow: "0 0 6px rgba(249,115,22,0.5)" }}
              >
                <span
                  className="w-3 h-[1px] inline-block"
                  style={{
                    background: "#f97316",
                ...
                {quickLinks.map((item) => {
                  ...
                  return (
                    <li key={item.label}>
                      ...
                      >
                        <span style={{ color: active ? "#fb923c" : "#7c2d12" }}>
                          ›
                        </span>
                        {item.label}
                        {active && (
                  ...
                  {socials.map((s: any) => (
                    <a
                      ...
                      style={{
                        ...
                        boxShadow:
                          activeSocial === s.name
                            ? "0 0 12px rgba(249,115,22,0.4), inset 0 0 8px rgba(249,115,22,0.1)"
                            : "none",
                        textDecoration: "none",
                        cursor: "pointer",
                      }}
